...
ALTER TABLE PRESENCA_OFICINA
    ADD CONSTRAINT dmf_id FOREIGN KEY
        (
         dmf_id
            )
        REFERENCES DIAS_MARCADOS_OFICINAS
            (
             dmf_id
                )
;
...
ALTER TABLE OFERTAR_OFICINA
    ADD CONSTRAINT ofc_pk FOREIGN KEY
        (
         ofc_pk
            )
        REFERENCES OFICINA
